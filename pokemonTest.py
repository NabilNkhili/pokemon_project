...
IMAGE_DIR = "static/pokemon_images"
...
def main():
    ...
    max_pokemon = 5  # Limite de Pokémon à traiter
    ...
    rdf_graph.serialize(destination="all_pokemonTest.ttl", format="turtle", encoding="utf-8")
    print(f"✅ Fichier RDF généré avec succès : all_pokemonTest.ttl")
